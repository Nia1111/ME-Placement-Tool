...
- **複数の配置モード**:
  - **ラインモード**: ケーブルを直線に素早く設置できます
  - **平面敷き詰め**: 長方形の範囲にケーブルネットを設置します
...
![スペクトラムの鍵非使用時](../../assets/me_cable_placement_tool_gui_no_key.png)

- **手動染色**: オフハンドに染料を持っている場合、染料を消費し設置されたケーブルを自動的に着色します

### スペクトラムの鍵使用時

![スペクトラムの鍵使用時](../../assets/me_cable_placement_tool_gui_with_key.png)
